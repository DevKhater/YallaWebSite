...
class GalleryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $galleryPreview = $em->getRepository("ApplicationSonataMediaBundle:Gallery")->findAll();
    ...
    public function setGalleryPreviewAction(Request $request)
    {
        ...
        $medias = $em->getRepository("ApplicationSonataMediaBundle:GalleryHasMedia")->findBy(array('gallery' => $gallery_id));
