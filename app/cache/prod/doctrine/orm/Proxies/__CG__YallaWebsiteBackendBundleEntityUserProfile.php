 ...
 */
class UserProfile extends \YallaWebsite\BackendBundle\Entity\UserProfile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\UserProfile' . "\0" . 'id', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\UserProfile' . "\0" . 'displayName', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\UserProfile' . "\0" . 'shortBio', 'media');
        }
    ...
    public function setShortBio($shortBio)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShortBio', array($shortBio));
    ...
    public function getShortBio()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShortBio', array());
