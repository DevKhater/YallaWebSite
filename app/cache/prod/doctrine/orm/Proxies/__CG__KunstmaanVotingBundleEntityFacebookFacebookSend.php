...
namespace Proxies\__CG__\Kunstmaan\VotingBundle\Entity\Facebook;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class FacebookSend extends \Kunstmaan\VotingBundle\Entity\Facebook\FacebookSend implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacebookSend $proxy) {
