 ...
 */
class Artist extends \YallaWebsite\BackendBundle\Entity\Artist implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Artist' . "\0" . 'id', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Artist' . "\0" . 'title', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Artist' . "\0" . 'biography', 'media', 'sm', 'slug', 'ogType');
        }
    ...
    public function setSm(\YallaWebsite\BackendBundle\Entity\SocialMedia $sm = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSm', array($sm));

        return parent::setSm($sm);
    }
    ...
    public function getSm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSm', array());
