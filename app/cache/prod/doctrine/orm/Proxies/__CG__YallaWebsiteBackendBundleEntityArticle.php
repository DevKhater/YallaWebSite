 ...
 */
class Article extends \YallaWebsite\BackendBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Article' . "\0" . 'title', 'ogType', 'metaTags', 'metaDescription', 'url', 'mediaUrl', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Article' . "\0" . 'author', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Article' . "\0" . 'content', 'media', 'tags', 'updatedAt', 'createdAt', 'slug');
        }
