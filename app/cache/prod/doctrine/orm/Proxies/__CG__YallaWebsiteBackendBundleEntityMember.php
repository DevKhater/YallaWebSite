 ...
 */
class Member extends \YallaWebsite\BackendBundle\Entity\Member implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Member' . "\0" . 'id', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Member' . "\0" . 'name', '' . "\0" . 'YallaWebsite\\BackendBundle\\Entity\\Member' . "\0" . 'website', 'media');
        }
