...
$catalogue = new MessageCatalogue('hu', array (
  ...
  array (
    ...
    'breadcrumb.link_gallery_create' => 'Létrehoz',
    'breadcrumb.link_media_show' => 'Mutat',
    ...
    'form.label_cdn_is_flushable' => 'CDN cache törlése',
    ...
    'label.cdn' => 'CDN',
    'label.to_be_flushed' => 'Cache törlésre vár',
    'label.flushed_at' => 'Cache törölve',
    'label.public_url' => 'Publikus URL',
    'label.name' => 'Név',
    'label.file' => 'File',
    'label.author' => 'Szerző',
    'label.enabled' => 'Engedélyezve',
    'label.cdn_is_flushable' => 'CDN cache törlése',
